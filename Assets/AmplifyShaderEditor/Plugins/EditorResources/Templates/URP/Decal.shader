		...
		*/
        ...
        Pass
        {
			...
			)
			{
				...
				/*ase_unity_cond_begin:<20230207*/
				#if ASE_SRP_VERSION <=160005
				float depth = LOAD_FRAMEBUFFER_INPUT(GBUFFER3, packedInput.positionCS.xy);
				#endif
				/*ase_unity_cond_end*/
