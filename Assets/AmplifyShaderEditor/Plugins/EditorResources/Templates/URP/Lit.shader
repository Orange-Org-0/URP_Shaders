	...
	SubShader
	{
		/*ase_subshader_options:Name=Additional Options
			...
			Option:Alpha Clipping:false,true:true
				...
				true:SetDefine:DepthNormals:pragma multi_compile_local_fragment _ALPHATEST_ON
				...
				false:RemoveDefine:DepthNormals:pragma multi_compile_local_fragment _ALPHATEST_ON
